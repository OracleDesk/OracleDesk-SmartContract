...
requests, discussions, and any other project-associated communication
channel), and also applies when an individual is officially representing
...
[GitHub security advisory](../../security/advisories/new) or a private
issue. <!-- TODO(maintainer): add a direct contact (email or otherwise) if
you want one alongside the GitHub-based reporting path. -->
